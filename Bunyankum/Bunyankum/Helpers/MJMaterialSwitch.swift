...
class MJMaterialSwitch: UIControl {
    ...
    func initialize() {
        ...
        self.thumbOnTintColor  = .white // UIColor(red:52.0 / 255.0, green:109.0 / 255.0, blue:241.0 / 255.0, alpha:1.0) //  UIColor(hexString: "FFFFFF")//
        self.thumbOffTintColor = .white //UIColor(red:249.0 / 255.0, green:249.0 / 255.0, blue:249.0 / 255.0, alpha:1.0)

        self.trackOnTintColor = UIColor(red:143.0 / 255.0, green:179.0 / 255.0, blue:247.0 / 255.0, alpha:1.0) //UIColor(hexString: "DB0000")
